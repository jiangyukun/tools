...
export const environment: Environment = {
  paths: {
    ...
    ICON_OUTPUT_DIR: path.resolve(__dirname, '../../dist/'),
    ...
    INDEX_OUTPUT: path.resolve(__dirname, '../../dist/index.ts'),
    MANIFEST_OUTPUT: path.resolve(__dirname, '../../dist/manifest.ts'),
    DIST_TEMPLATE: path.resolve(__dirname, './templates/dist.ts.template'),
    DIST_OUTPUT: path.resolve(__dirname, '../../dist/dist.ts'),
    TYPES_TEMPLATE: path.resolve(__dirname, './templates/types.ts'),
    TYPES_OUTPUT: path.resolve(__dirname, '../../dist/types.ts'),
    HELPERS_TEMPLATE: path.resolve(__dirname, './templates/helpers.ts'),
    HELPERS_OUTPUT: path.resolve(__dirname, '../../dist/helpers.ts'),
    INLINE_SVG_OUTPUT_DIR: path.resolve(__dirname, '../../dist/inline-svg/'),
